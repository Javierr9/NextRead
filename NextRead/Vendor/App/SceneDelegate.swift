...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo _: UISceneSession, options _: UIScene.ConnectionOptions) {
        ...
        nextReadNavigationController = UINavigationController(rootViewController: RootViewController())
        bookLibraryNavigationController = UINavigationController(rootViewController: BookLibraryViewController())
